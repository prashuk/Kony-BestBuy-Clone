...
function reviewsMoveup() {
    ...
    ProductDetailsScreen.FlexReview.animate(
    ...
    ProductDetailsScreen.FlexImageUpArrow.animate(
    kony.ui.createAnimation({
        "100": {
            "top": "0%",
            "stepConfig": {
...
function SearchButton() {
  HomeScreen.FlexCustomSearchArea.animate(
  kony.ui.createAnimation({
      "100": {
          "left": "0%",
          "stepConfig": {
  ...
  HomeScreen.FlexHomeContent.animate(
  kony.ui.createAnimation({
      "100": {
          "top": "30%",
          "stepConfig": {
...
function totalanimation() {
    ...
    ShoppingCartScreen.totalvalue.animate(
    kony.ui.createAnimation({
        "100": {
            "anchorPoint": {
                "x": 0.5,
