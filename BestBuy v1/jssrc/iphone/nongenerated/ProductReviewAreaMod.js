...
function Productdetailsdetailreviewresponse() {
    if (kony.net.isNetworkAvailable(constants.NETWORK_TYPE_ANY)) {
        kony.application.showLoadingScreen("loadskin", "Fetching reviews/details...", constants.LOADING_SCREEN_POSITION_FULL_SCREEN, false, true, {
            enableMenuKey: true,
            enableBackKey: true,
...
function reviewSuccess(detailreviewresponse) {
    ...
    if (detailreviewresponse !== null && detailreviewresponse.opstatus === 0) {
        ...
        kony.ui.Alert({
            message: "Failed ServiceCalls with opStatus " + productlistresponse.opstatus,
