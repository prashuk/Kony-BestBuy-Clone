...
function AS_Button_f1741d36ed4b407599f2c7bf966664af(eventobject) {
    return goToNextPage.call(this);
}

function AS_Button_ff0785887d0c4001b8557ce8db93573f(eventobject) {
    return goToPreviousPage.call(this);
}
...
function AS_FlexContainer_1e517ba04ce346e0b9f37f1dac08a385(eventobject) {
    return redirectFromStoreLocatorScreenToHomeScreen.call(this);
}
...
function AS_FlexContainer_315cc5aad1e1482c8de992a4d58969b2(eventobject) {
    return redirectFromStoreLocatorScreenToStoreLocatorScreen.call(this);
}
...
function AS_FlexContainer_83fc89949c0841d698adfb6ba5f8d3e6(eventobject) {
    return openHamburgerMenuStoreLocatorScreen.call(this);
}
...
function AS_FlexContainer_c679e0e61336410dbae1be49a040cdf2(eventobject) {
    return redirectFromStoreLocatorScreenToShoppingCartScreen.call(this);
}
...
function AS_FlexContainer_f2836c9dfa694296a4b67b2a3c0f3755(eventobject) {
    closeHamburgerMenuStoreLocatorScreen.call(this);
}
