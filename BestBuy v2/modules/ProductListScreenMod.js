    ...
    for(var i = 0; i < Productlistresponse.ListOfProducts.length; i++) {
      ...
      if (Productlistresponse.ListOfProducts[i].isOnSale === true) {
        anyObject = {
          ...
          productListPrice:{text : "$ " + Productlistresponse.ListOfProducts[i].SalesPrice, skin:"red"},
          Onsale:{isVisible:true}
        };
        ...
        anyObject = {
          ...
          ProductListreview: avgReview,
          ImgProduct: Productlistresponse.ListOfProducts[i].Image,
          productListPrice:{text : "$ " + Productlistresponse.ListOfProducts[i].RegularPrice},
          Onsale:{isVisible: false}
        };
        dataArray.push(anyObject);
      }
    }
...
function getProductListData() {
  if (kony.net.isNetworkAvailable(constants.NETWORK_TYPE_ANY)) {
    kony.application.showLoadingScreen("loadskin","Fetching products list...",constants.LOADING_SCREEN_POSITION_FULL_SCREEN , false,true,{enableMenuKey:true,enableBackKey:true, progressIndicatorColor : "ffffff77"});
    ...
    var headers = {};
    data= {CatogeryId:productId,ApiKey:apikey,page:firstPage,pageSize:pagesize};
